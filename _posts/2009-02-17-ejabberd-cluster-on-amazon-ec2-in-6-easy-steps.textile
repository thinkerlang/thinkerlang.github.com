...
<pre class="terminal"><code>`hostname -s`</code></pre> does not work here.

2) Edit /etc/init.d/ejabberd

Use <pre class="terminal"><code>-name ejabberd@$node</code></pre> instead of <pre class="terminal"><code>
-sname ejabberd</code></pre> everywhere. This applies to <pre class="terminal"><code>-sname ejabberdctl</code></pre> too.
